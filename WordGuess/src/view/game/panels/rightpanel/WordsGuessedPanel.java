...
public class WordsGuessedPanel extends JPanel 
{
	...
	public WordsGuessedPanel()
	{
		...
		jWordList.setForeground(new Color(0, 0, 0));
		jWordList.setBackground(new Color(192, 192, 192));
		 ...
		 * all four sides.							  *
		 ******************************************** */
		setBorder(new CompoundBorder(new EmptyBorder(5, 5, 5, 5), new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Incorrect Word Guesses This Turn: ", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 255, 255))));		//combines the two bits of border information
